// Copyright (c) 2016-2017 CryptoCoderz
...
void BlockBrowser::updateExplorer(bool block)
{
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " INSANE");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " INSANE");
    }
}
...
void BlockBrowser::updateStatistics()
{
    ...
    else if (pindexBest->nHeight > 0 && pindexBest->nHeight < LAST_POW_BLOCK)
    {
        phase = "PoW+PoS";
    }
    ...
    {
        ui->heightBox_3->setText("<b><font color=\"blue\">" + height + "</font></b>");
    } else {
    ...
    {
        ui->minBox_2->setText("<b><font color=\"blue\">" + stakemin + "</font></b>");
    } else {
    ui->minBox_2->setText(stakemin);
    }
    if(0 > stakemaxPrevious)
    {
        ui->maxBox_2->setText("<b><font color=\"blue\">" + stakemax + "</font></b>");
    } else {
    ...
    {
        ui->cBox_2->setText("<b><font color=\"blue\">" + phase + "</font></b>");
    } else {
    ...
    {
        ui->diffBox_2->setText("<b><font color=\"blue\">" + hardness + "</font></b>");
    ...
    {
        ui->diffBox2_2->setText("<b><font color=\"blue\">" + hardness2 + "</font></b>");
    ...
    {
        ui->pawrateBox_2->setText("<b><font color=\"blue\">" + pawrate + " MH/s</font></b>");
    ...
    {
        ui->localBox_2->setText("<b><font color=\"blue\">" + Qlpawrate + "</font></b>");
    } else {
    ...
    {
        ui->connectionBox_2->setText("<b><font color=\"blue\">" + QPeers + "</font></b>");
    ...
    {
        ui->volumeBox_2->setText("<b><font color=\"blue\">" + qVolume + " INSANE" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox_2->setText("<b><font color=\"red\">" + qVolume + " INSANE" + "</font></b>");
    } else {
        ui->volumeBox_2->setText(qVolume + " INSANE");
    }
